...
$pagedes=$_POST['pagedes'];
 ...
 $query=mysqli_query($con,"update tblpages set PageTitle='$pagetitle',PageDescription='$pagedes' where  PageType='shuvo'");

    if ($query) {
    $msg="shuvo has been updated.";
  }
  else
    {
...
<!DOCTYPE html>
<head>
<title>Paying Guest Accomodation System|| shuvo  </title>
...
$ret=mysqli_query($con,"select * from  tblpages where PageType='shuvo'");
$cnt=1;
