...
if (strlen($_SESSION['pgasuid']==0)) {
  header('location:logout.php');
   ...
   /* $verifynum="Your Payment Is Successful <br /><br />Your transaction ID for this transaction is <b>".$txnid."</b>";
    $veriURl = "<br><br>Your Booking Number is <b>".$bookingnumber."</b>";
    $p1="<br /><br />We have received a payment of ";
    $p2=" <br /><br />We have received a payment of <b>".$amount."</b>/- INR";
...
<head>
            ...
            THANK YOU<br><br>
                                    ...
                                    <h2 class="text-black-50 animated zoomIn">
                                        Your Payment Is Successful<br><br>
                                               ...
                                               Your Booking Number is <b>".$bookingnumber."</b><br><br>
  ...
  <!--    $message=" Your Payment Is Successful <br /><br />Your transaction ID for this transaction is <b>".$txnid."</b><br><br>Your Booking Number is <b>".$bookingnumber."</b><br /><br />We have received a payment of <b>".$amount."</b>/- INR";
