...
<head>
	...
	<title>RentCare Accomodation</title>
			...
			<div class="row d-flex text-center align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					<p class="text-white link-nav"><a href="index.php">Home </a>
						...
						RentCare Accomodation</a></p>
					<h1 class="text-white">
					RentCare Accomodation
					</h1>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row d-flex justify-content-center">
				<div class="col-md-10 header-text">
					<h1>RentCare Accomodation in Various Cities</h1>
					<p>
...
$ret=mysqli_query($con,"select * from tblpg where norooms>0");
$cnt=1;
