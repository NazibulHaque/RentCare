...
if(isset($_POST['submit']))
  {
    ...
    $email=$_GET['e'];
    $verifycode=$_GET['v'];
    $sessioncode=$_SESSION['onetimeuse'];
   // $msg=$email;
   // echo "<script>alert('.$email.')</script>";
    //$password=md5($_POST['newpassword']);
    $pass=$_POST['passwd'];
    $re_pass=$_POST['re_passwd'];
	...
	$msg="Something wents wrong, Please try Again ";
}
...
<head>
	...
	<title>RentCare Guest Accomodation System|| Reset Password</title>
