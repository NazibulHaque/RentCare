...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>RentCare Guest Accomodation System|| PG Response</title>
...
$id=$_SESSION['pgasuid'];
$ret=mysqli_query($con,"SELECT * FROM  tblbookpg.Id as bookid,tblbookpg.BookingNumber,tblbookpg.BookingDate,tblbookpg.CheckinDate,tblbookpg.CheckoutDate,tblbookpg.Status,tblpg.PGTitle,tblpg.RPmonth from tblbookpg join tblpg on tblpg.id=tblbookpg.Pgid where Userid='$id'");
$cnt=1;
